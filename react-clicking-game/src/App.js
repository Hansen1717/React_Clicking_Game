    ...
    return (
      ...
      <div className="App" id="App">
        <header id="App-header">
          ...
          <h1 className="App-title">Click The Simpson's Character to build your score! <br />Don't choose the same character twice though or your score is reset to 0!</h1>
        </header>
